...
Within MGLMMs there is also the option to use a distance matrix between species to inform the result - further information on this will appear in a phylogenetic specific vignette as soon as I get around to writing one.
...
mcmc_plot(mglmm_fit, plotfun = "recover_intervals",
          ...
          true = c(mglmm_test_data$pars$L_Rho_species)) +
