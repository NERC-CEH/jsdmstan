...
Within MGLMMs there is also the option to use a distance matrix between species to inform the result - further information on this appears in the Phylogenetic Models vignette.
...
mcmc_plot(mglmm_fit, plotfun = "recover_intervals",
          ...
          true = mglmm_test_data$pars$sigmas_u)
```
```{r}
mcmc_plot(mglmm_fit, plotfun = "recover_intervals",
