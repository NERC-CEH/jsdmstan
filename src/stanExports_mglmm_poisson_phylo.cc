...
#include "stanExports_mglmm_poisson_phylo.h"

RCPP_MODULE(stan_fit4mglmm_poisson_phylo_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mglmm_poisson_phylo")
