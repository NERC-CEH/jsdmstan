...
#include "stanExports_gllvm_bernoulli.h"

RCPP_MODULE(stan_fit4gllvm_bernoulli_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_gllvm_bernoulli")
