...
#include "stanExports_mglmm_gaussian.h"

RCPP_MODULE(stan_fit4mglmm_gaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mglmm_gaussian")
