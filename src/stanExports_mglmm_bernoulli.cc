...
#include "stanExports_mglmm_bernoulli.h"

RCPP_MODULE(stan_fit4mglmm_bernoulli_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mglmm_bernoulli")
