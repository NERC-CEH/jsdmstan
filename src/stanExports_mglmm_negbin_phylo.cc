...
#include "stanExports_mglmm_negbin_phylo.h"

RCPP_MODULE(stan_fit4mglmm_negbin_phylo_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mglmm_negbin_phylo")
