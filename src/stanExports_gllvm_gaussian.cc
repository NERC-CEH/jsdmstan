...
#include "stanExports_gllvm_gaussian.h"

RCPP_MODULE(stan_fit4gllvm_gaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_gllvm_gaussian")
