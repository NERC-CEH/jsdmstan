...
#'across native Scots Pine woodlands in Scotland surveyed in 1971. It contains
#'both a table of 16 tree species measured over 265 plots plus the approximate
#'location of each site, the soil pH of each plot plus the average annual
#'rainfall, maximum summer temperature and minimum winter temperature from
#'1941-1970. All climate variables were calculated based upon the HadUK-Grid
#'climate data (Met Office et al., 2022). For further information on this data
#'see Wood and Bunce (2016).  This dataset has been limited to the 265 plots
#'across 25 sites that have soil pH measurements.
#'
#'This data is made available under the terms of the Open Government Licence.
#'
#'@format A list containing two data.frames. The first (\code{"abund"}) data
#'frame has 265 rows and 16 columns. Each column is a species, or species
#'aggregates and each row is a plot. The plot identity is marked in the rownames
#'of the data frame. Every entry is given as the number of individuals of that
#'species that is observed in within the plot. The second (\code{"env"}) is a
#'data frame with 265 rows and 10 columns, with columns as described below.
#'
#' \describe{
...
#' }
#'
#'@references { Wood, C. M., & Bunce, R. G. H. (2016). Ecological survey of the
#'  native pinewoods of Scotland 1971. Earth System Science Data, 8(1), 177-189.
